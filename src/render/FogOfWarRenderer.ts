...
const STRATA_CONFIGS: FogStratumConfig[] = [
  {
    name: 'GroundMist',
    // The two lowest decks hover at building-wall heights (2–7 m) — if they
    // render as flat, fairly opaque planes they read as a “surface” the
    // building bottoms are sunk under. Strong billow + low density keeps them
    // reading as wispy ground fog instead of a buried-floor cutoff.
    baseHeight: 1.8,
    billowAmp: 4.5,
    wallHeight: 3.0,
    noiseScale: 2.4,
